...
class PassengerViewModel: NSObject, ObservableObject, CLLocationManagerDelegate {
    ...
    // search the bus for bus number in the passenger search bar
    @Published var busNum: String = ""
    
    // Show list of bus
    @Published var showBusList: Bool = false
    
    
    // show list of bus destinations
    @Published var showBusDestinations: Bool = false
    ...
    func selectRoute(_ location: String){
        self.selectedRoute = location
